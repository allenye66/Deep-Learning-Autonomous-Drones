...
class DroneVision:
    def __init__(self, drone_object, model, buffer_size=2, cleanup_old_images=True):
        """
        ...
        while (self.vision_running):
            ...
            try:
                ...
                if (not os.path.exists(path)) and (not os.path.isfile(path)):
                    #print("File %s doesn't exist" % (path)) ALREADY
                    #print(os.listdir(self.imagePath)) ALREADY
                    continue
                ...
                # print("Trying to read an empty png. Let's wait and try again.") ALREADY
                self.image_index = self.image_index - 1
                continue
